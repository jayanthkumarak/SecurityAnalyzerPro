  ...
  return (
    <div className='min-h-screen bg-gray-900 flex items-center justify-center'>
      <div className='text-center'>
        ...
        {/* App Title */}
        <h1 className='text-2xl font-bold text-white mb-2'>SecurityAnalyzer Pro</h1>
        <p className='text-gray-400 mb-8'>AI-Powered Digital Forensics Platform</p>
        ...
        <div className='mt-8 text-xs text-gray-600'>
          ...
          <p className='mt-1'>Powered by Claude AI & Electron</p>
        </div>
      </div>
    </div>
  );
